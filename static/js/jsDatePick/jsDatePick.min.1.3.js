...
g_jsDatePickImagePath = "../static/js/jsDatePick/img/";
...
JsDatePick.prototype.populateFieldWithSelectedDate = function() {
	JsgetElem(this.oConfiguration.target).value = this
...
JsDatePick.prototype.setControlBarText = function(a) {
	...
	while (this.controlsBarTextCell.firstChild) {
		this.controlsBarTextCell
				.removeChild(this.controlsBarTextCell.firstChild)
	}
